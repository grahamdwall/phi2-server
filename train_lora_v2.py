...
dataset = load_dataset("json", data_files={"train": "mortgage_finetune/mortgage_finetune_1000.jsonl"}, split="train")
...
def tokenize_function(examples):
    ...
    tokens["labels"] = tokens["input_ids"].copy()  # Fix missing labels
    return tokens
